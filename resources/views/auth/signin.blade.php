...
<head>
    ...
    <title>Đăng nhập - AI Cây Thương Hiệu</title>
    ...
    <div class="signin-container">
            ...
            <div class="signin-form-section">
                <form class="signin-form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="divider-section">
                        ...
                        <span class="divider-text">Hoặc đăng nhập với Google</span>
                        <div class="divider-line"></div>
                    </div>
                    ...
                    <p class="signup-prompt">
                        Bạn chưa có tài khoản? <a href="#" class="signin-link-inline">Đăng ký</a>
                    </p>
                </form>
            </div>
        </div>
        ...
        <div class="signin-right">
            <div class="auth-links">
                <a href="#" class="signin-link active">Đăng nhập</a> <!-- ready to use animation -->
                <a href="#" class="signup-link">Đăng ký</a>
            </div>
